      ...
      <PopoverContent className="w-80 p-0" align="start">
        ...
        <div className="p-3 space-y-3">
          ...
          <div className="flex justify-end pt-2">
            <Button size="sm" onClick={handleSubmit} disabled={!input.trim() || isProcessing} className="h-8">
              {isProcessing ? <Loader2 className="w-3.5 h-3.5 animate-spin mr-1" /> : <Sparkles className="w-3.5 h-3.5 mr-1" />}
