...
> **版本**：v0.100.x (UniversalParrot 配置驱动)
...
> **v0.100.x 更新**: UniversalParrot 配置驱动架构引入新测试需求：
> - `ai/agents/universal/` - UniversalParrot 执行策略测试
> - `ai/routing/` - 两层路由（Cache + Rule Matcher）测试
